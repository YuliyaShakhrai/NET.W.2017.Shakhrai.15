...
namespace BLL.Interface.Entities
{
    public sealed class GoldAccount : BankAccount
    {
        ...
        public GoldAccount(string iban, string firstName, string lastName) : base(iban, firstName, lastName)
        {
        }

        public GoldAccount(string iban, string firstName, string lastName, decimal balance, long bonusPoints, bool isClosed) : base(iban, firstName, lastName, balance, bonusPoints, isClosed)
        {
        }
